...
export default function SetupGallery(canvasElement, polkadotAPI) {
  ...
  const gameClient = new GameClient(engine, scene);
  const loop = function () {
  ...
  wallSouth.position = new Vector3(0, 0.5, -50);
